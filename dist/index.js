...
var import_canvas10 = require("@napi-rs/canvas");
var import_cropify9 = require("cropify");
registerFont("PlusJakartaSans-Bold.ttf", "bold");
registerFont("PlusJakartaSans-ExtraBold.ttf", "extrabold");
registerFont("PlusJakartaSans-ExtraLight.ttf", "extralight");
registerFont("PlusJakartaSans-Light.ttf", "light");
...
var Greeting = async (option) => {
  ...
  let avatar;
  try {
    avatar = await (0, import_canvas10.loadImage)(
      await (0, import_cropify9.cropImage)({
  ...
  try {
    const canvas = (0, import_canvas10.createCanvas)(2458, 837);
    const ctx = canvas.getContext("2d");
    if (option.backgroundImage) {
      try {
        const image = await (0, import_cropify9.cropImage)({
          imagePath: option.backgroundImage,
          width: 2458,
          height: 837,
          cropCenter: true,
        ...
        const img = await (0, import_canvas10.loadImage)(image);
        ctx.filter = "blur(10px)";
        ctx.drawImage(img, 0, 0);
        ctx.filter = "none";
        ...
        ctx.drawImage(await (0, import_canvas10.loadImage)(darknessSvg), 0, 0);
      } catch (_err) {
        const backgroundSvg = generateSvg(`<svg width="2458" height="837" viewBox="0 0 2458 837" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="2458" height="837" rx="50" fill="${option.backgroundColor}"/>
                </svg>`);
        const background = await (0, import_canvas10.loadImage)(backgroundSvg);
        ctx.drawImage(background, 0, 0);
      }
    } else {
      const backgroundSvg = generateSvg(`<svg width="2458" height="837" viewBox="0 0 2458 837" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const border = await (0, import_canvas10.loadImage)(borderSvg);
    ...
    const accentLine = await (0, import_canvas10.loadImage)(accentLineSvg);
    ...
    const memberBadge = await (0, import_canvas10.loadImage)(memberBadgeSvg);
...
var import_canvas11 = require("@napi-rs/canvas");
var import_cropify10 = require("cropify");
...
var GreetingV2 = async (option) => {
  ...
  let avatar;
  try {
    avatar = await (0, import_canvas11.loadImage)(
      await (0, import_cropify10.cropImage)({
        imagePath: option.avatarImage,
        borderRadius: 50,
        width: 837,
        height: 837,
  ...
  try {
    const canvas = (0, import_canvas11.createCanvas)(2458, 837);
    const ctx = canvas.getContext("2d");
    if (option.backgroundImage) {
      try {
        const image = await (0, import_cropify10.cropImage)({
          imagePath: option.backgroundImage,
          width: 1568,
          height: 837,
          cropCenter: true
        ...
        await (0, import_cropify10.cropImage)({
          ...
          const img = await (0, import_canvas11.loadImage)(x);
          ctx.filter = "blur(10px)";
          ctx.drawImage(img, 0, 0);
          ctx.filter = "none";
        });
        ...
        ctx.drawImage(await (0, import_canvas11.loadImage)(darknessSvg), 0, 0);
      } catch (_err) {
        const backgroundSvg = generateSvg(`<svg width="2458" height="837" viewBox="0 0 2458 837" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="1568" height="512" rx="50" fill="${option.backgroundColor}"/>
                <rect y="565" width="1568" height="272" rx="50" fill="${option.backgroundColor}"/>
                </svg>`);
        const background = await (0, import_canvas11.loadImage)(backgroundSvg);
        ctx.drawImage(background, 0, 0);
      }
    } else {
      const backgroundSvg = generateSvg(`<svg width="2458" height="837" viewBox="0 0 2458 837" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const memberBadge = await (0, import_canvas11.loadImage)(memberBadgeSvg);
    ctx.drawImage(memberBadge, 113, 650);
    const usersIcon = await (0, import_canvas11.loadImage)(Icons.users({ color: option.accentColor, size: 50 }));
    ...
    const joinedBadge = await (0, import_canvas11.loadImage)(joinedBadgeSvg);
    const memberBadgeEnd = 113 + memberBadgeWidth + 350;
    ctx.drawImage(joinedBadge, memberBadgeEnd, 650);
    const calendarIcon = await (0, import_canvas11.loadImage)(Icons.calendar({ color: option.accentColor, size: 50 }));
